...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "2Px2xu6dNzDzNWajabshuzn9GxnXP1HEctvXLm4Wuf7B";
        String sdkKey = "HLQVxQwuGUHLG9P8NLPEiSmCmM24hVN3nYbSJAJPvbxR";

        FaceEngine faceEngine = new FaceEngine("D:\\WIN64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("D:/home/face/image/666666666/1234567.jpg"));
        List<FaceInfo> faceInfoList = new ArrayList<FaceInfo>();
        errorCode = faceEngine.detectFaces(imageInfo.getImageData(), imageInfo.getWidth(), imageInfo.getHeight(), imageInfo.getImageFormat(), faceInfoList);
        System.out.println(faceInfoList);

        //人脸检测2
        /*ImageInfo imageInfo2 = getRGBData(new File("D:/home/face/image/666666666/123456.jpg"));
        ...
        //IR属性处理
        ImageInfo imageInfoGray = ImageFactory.getGrayData(new File("D:/home/face/image/666666666/123456.jpg"));
